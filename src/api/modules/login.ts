 ...
 * @LastEditTime: 2022-11-15 10:51:50
 * @FilePath: \Geeker-Admin\src\api\modules\login.ts
 */
...
export const loginApi = (params: Login.ReqLoginForm) => {
	return http.post<Login.ResponseLogin>(`/login`, params, { headers: { noLoading: true } }); // 正常 post json 请求  ==>  application/json
